            ...
            {result ? (
                ...
                <>
                    <div className='question-section'>
                        ...
                        <div className='question-text'><h2 id='h2'>{questions[currentQuestion].questionText}</h2></div>
                    </div>
                    <div className='answer-section'>
                        {questions[currentQuestion].answerOptions.map((answerOption) => (
                            <button id='button' key={questions.findIndex.toString()} onClick={() => handleAnswerOptionClick()}>{answerOption.answerText}</button>
                        ))}
                    </div>
                </>
            )}
